...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 87
    iput-boolean p2, p0, Lgp;->g:Z

    .line 88
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lgp;->setCacheColorHint(I)V
...
.method public onForwardedEvent(Landroid/view/MotionEvent;I)Z
    ...
    .line 2175
    invoke-virtual {p0, v1}, Lgp;->setPressed(Z)V

    .line 2177
    invoke-virtual {p0}, Lgp;->drawableStateChanged()V

    .line 2179
    iget v0, p0, Lgp;->mMotionPosition:I

    invoke-virtual {p0}, Lgp;->getFirstVisiblePosition()I

    move-result v4

    sub-int/2addr v0, v4

    invoke-virtual {p0, v0}, Lgp;->getChildAt(I)Landroid/view/View;
    ...
    .line 2184
    :cond_2
    iget-object v0, p0, Lgp;->i:Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    iput-object v0, p0, Lgp;->i:Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    .line 141
    iget-object v0, p0, Lgp;->j:Landroid/support/v4/widget/ListViewAutoScrollHelper;
    ...
    iput-object v0, p0, Lgp;->j:Landroid/support/v4/widget/ListViewAutoScrollHelper;
    ...
    .line 118
    invoke-virtual {p0, v5, v4}, Lgp;->pointToPosition(II)I
    ...
    .line 1195
    invoke-virtual {p0, v5, v4}, Lgp;->drawableHotspotChanged(FF)V

    .line 1197
    :cond_8
    invoke-virtual {p0}, Lgp;->isPressed()Z
    ...
    .line 1198
    invoke-virtual {p0, v2}, Lgp;->setPressed(Z)V

    .line 1202
    :cond_9
    invoke-virtual {p0}, Lgp;->layoutChildren()V

    .line 1206
    iget v7, p0, Lgp;->mMotionPosition:I
    ...
    invoke-virtual {p0, v7}, Lgp;->getChildAt(I)Landroid/view/View;
    ...
    .line 1212
    :cond_a
    iput v6, p0, Lgp;->mMotionPosition:I
    ...
    .line 1225
    :cond_c
    invoke-virtual {p0, v6, v0, v5, v4}, Lgp;->positionSelectorLikeTouchCompat(ILandroid/view/View;FF)V

    .line 1230
    invoke-virtual {p0, v1}, Lgp;->setSelectorEnabled(Z)V

    .line 1234
    invoke-virtual {p0}, Lgp;->refreshDrawableState()V

    .line 128
    if-ne v3, v2, :cond_0

    .line 2158
    invoke-virtual {p0, v6}, Lgp;->getItemIdAtPosition(I)J

    move-result-wide v4

    .line 2159
    invoke-virtual {p0, v0, v6, v4, v5}, Lgp;->performItemClick(Landroid/view/View;IJ)Z
