...
.field private final d:Lcom/squareup/picasso/Request$Builder;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/squareup/picasso/RequestCreator;->b:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method constructor <init>()V
    ...
    .line 79
    iput-object v2, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;
    ...
    iput-object v0, p0, Lcom/squareup/picasso/RequestCreator;->d:Lcom/squareup/picasso/Request$Builder;
...
.method constructor <init>(Lcom/squareup/picasso/Picasso;Landroid/net/Uri;I)V
    ...
    .line 70
    iget-boolean v0, p1, Lcom/squareup/picasso/Picasso;->p:Z
    ...
    .line 74
    :cond_0
    iput-object p1, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    .line 75
    new-instance v0, Lcom/squareup/picasso/Request$Builder;

    iget-object v1, p1, Lcom/squareup/picasso/Picasso;->m:Landroid/graphics/Bitmap$Config;
...
.method private a()Landroid/graphics/drawable/Drawable;
    ...
    .line 676
    iget-object v0, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    iget-object v0, v0, Lcom/squareup/picasso/Picasso;->f:Landroid/content/Context;
...
.method private a(J)Lcom/squareup/picasso/Request;
    ...
    .prologue
    .line 684
    sget-object v0, Lcom/squareup/picasso/RequestCreator;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 686
    iget-object v1, p0, Lcom/squareup/picasso/RequestCreator;->d:Lcom/squareup/picasso/Request$Builder;
    ...
    .line 690
    iget-object v2, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;
    ...
    .line 695
    :cond_0
    iget-object v3, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    .line 3455
    iget-object v4, v3, Lcom/squareup/picasso/Picasso;->d:Lcom/squareup/picasso/Picasso$RequestTransformer;

    invoke-interface {v4, v1}, Lcom/squareup/picasso/Picasso$RequestTransformer;->transformRequest(Lcom/squareup/picasso/Request;)Lcom/squareup/picasso/Request;
    ...
    const-string v4, "Request transformer "

    invoke-direct {v2, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v3, v3, Lcom/squareup/picasso/Picasso;->d:Lcom/squareup/picasso/Picasso$RequestTransformer;
...
.method private a(Lsu;)V
    ...
    invoke-virtual {p1, v0, v1}, Lsu;->a(Landroid/graphics/Bitmap;Lcom/squareup/picasso/Picasso$LoadedFrom;)V
    ...
    invoke-virtual {v0, p1}, Lcom/squareup/picasso/Picasso;->a(Lse;)V
...
.method public centerCrop()Lcom/squareup/picasso/RequestCreator;
    ...
    .prologue
    .line 229
    iget-object v0, p0, Lcom/squareup/picasso/RequestCreator;->d:Lcom/squareup/picasso/Request$Builder;
...
.method public fetch(Lcom/squareup/picasso/Callback;)V
    ...
    .line 1253
    iget-object v0, v0, Lcom/squareup/picasso/Request$Builder;->c:Lcom/squareup/picasso/Picasso$Priority;
    ...
    .line 430
    :cond_1
    invoke-direct {p0, v2, v3}, Lcom/squareup/picasso/RequestCreator;->a(J)Lcom/squareup/picasso/Request;
    ...
    invoke-static {v2, v0}, Lsy;->a(Lcom/squareup/picasso/Request;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, Lcom/squareup/picasso/Picasso;->a(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v2}, Lcom/squareup/picasso/Request;->b()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    iget v3, p0, Lcom/squareup/picasso/RequestCreator;->i:I

    iget v4, p0, Lcom/squareup/picasso/RequestCreator;->j:I

    iget-object v5, p0, Lcom/squareup/picasso/RequestCreator;->m:Ljava/lang/Object;

    move-object v7, p1

    invoke-direct/range {v0 .. v7}, Lsl;-><init>(Lcom/squareup/picasso/Picasso;Lcom/squareup/picasso/Request;IILjava/lang/Object;Ljava/lang/String;Lcom/squareup/picasso/Callback;)V

    .line 444
    iget-object v1, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    invoke-virtual {v1, v0}, Lcom/squareup/picasso/Picasso;->b(Lse;)V
...
.method public get()Landroid/graphics/Bitmap;
    ...
    .line 385
    iget-boolean v2, p0, Lcom/squareup/picasso/RequestCreator;->a:Z
    ...
    .line 388
    :cond_0
    iget-object v2, p0, Lcom/squareup/picasso/RequestCreator;->d:Lcom/squareup/picasso/Request$Builder;
    ...
    invoke-direct/range {v0 .. v6}, Lsn;-><init>(Lcom/squareup/picasso/Picasso;Lcom/squareup/picasso/Request;IILjava/lang/Object;Ljava/lang/String;)V
    ...
    iget-object v2, v2, Lcom/squareup/picasso/Picasso;->g:Lsk;

    iget-object v3, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    iget-object v3, v3, Lcom/squareup/picasso/Picasso;->h:Lcom/squareup/picasso/Cache;

    iget-object v4, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    iget-object v4, v4, Lcom/squareup/picasso/Picasso;->i:Lsw;

    invoke-static {v1, v2, v3, v4, v0}, Lsg;->a(Lcom/squareup/picasso/Picasso;Lsk;Lcom/squareup/picasso/Cache;Lsw;Lse;)Lsg;

    move-result-object v0

    invoke-virtual {v0}, Lsg;->a()Landroid/graphics/Bitmap;
...
.method public into(Landroid/widget/ImageView;Lcom/squareup/picasso/Callback;)V
    ...
    .line 624
    invoke-direct {p0}, Lcom/squareup/picasso/RequestCreator;->a()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-static {p1, v0}, Lss;->a(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 2249
    iget v1, v0, Lcom/squareup/picasso/Request$Builder;->a:I

    if-nez v1, :cond_3

    iget v0, v0, Lcom/squareup/picasso/Request$Builder;->b:I
    ...
    invoke-direct {v1, p0, p1, p2}, Lsj;-><init>(Lcom/squareup/picasso/RequestCreator;Landroid/widget/ImageView;Lcom/squareup/picasso/Callback;)V

    .line 2466
    iget-object v0, v0, Lcom/squareup/picasso/Picasso;->k:Ljava/util/Map;
    ...
    .line 642
    :cond_8
    iget-object v4, p0, Lcom/squareup/picasso/RequestCreator;->d:Lcom/squareup/picasso/Request$Builder;
    ...
    .line 646
    invoke-static {v10}, Lsy;->a(Lcom/squareup/picasso/Request;)Ljava/lang/String;
    ...
    iget-object v1, v0, Lcom/squareup/picasso/Picasso;->f:Landroid/content/Context;

    sget-object v3, Lcom/squareup/picasso/Picasso$LoadedFrom;->MEMORY:Lcom/squareup/picasso/Picasso$LoadedFrom;

    iget-boolean v4, p0, Lcom/squareup/picasso/RequestCreator;->e:Z

    iget-object v0, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    iget-boolean v5, v0, Lcom/squareup/picasso/Picasso;->n:Z

    move-object v0, p1

    invoke-static/range {v0 .. v5}, Lss;->a(Landroid/widget/ImageView;Landroid/content/Context;Landroid/graphics/Bitmap;Lcom/squareup/picasso/Picasso$LoadedFrom;ZZ)V
    ...
    iget-boolean v11, p0, Lcom/squareup/picasso/RequestCreator;->e:Z
    ...
    invoke-direct/range {v0 .. v11}, Lso;-><init>(Lcom/squareup/picasso/Picasso;Landroid/widget/ImageView;Lcom/squareup/picasso/Request;IIILandroid/graphics/drawable/Drawable;Ljava/lang/String;Ljava/lang/Object;Lcom/squareup/picasso/Callback;Z)V

    .line 671
    iget-object v1, p0, Lcom/squareup/picasso/RequestCreator;->c:Lcom/squareup/picasso/Picasso;

    invoke-virtual {v1, v0}, Lcom/squareup/picasso/Picasso;->a(Lse;)V
...
.method public into(Landroid/widget/RemoteViews;IILandroid/app/Notification;)V
    ...
    .line 548
    :cond_2
    iget-object v2, p0, Lcom/squareup/picasso/RequestCreator;->k:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lcom/squareup/picasso/RequestCreator;->l:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v10, p0, Lcom/squareup/picasso/RequestCreator;->m:Ljava/lang/Object;

    iget v11, p0, Lcom/squareup/picasso/RequestCreator;->h:I
    ...
    invoke-direct/range {v0 .. v11}, Lsu$b;-><init>(Lcom/squareup/picasso/Picasso;Lcom/squareup/picasso/Request;Landroid/widget/RemoteViews;IILandroid/app/Notification;IILjava/lang/String;Ljava/lang/Object;I)V

    .line 560
    invoke-direct {p0, v0}, Lcom/squareup/picasso/RequestCreator;->a(Lsu;)V
...
.method public into(Landroid/widget/RemoteViews;I[I)V
    ...
    iget v6, p0, Lcom/squareup/picasso/RequestCreator;->i:I

    iget v7, p0, Lcom/squareup/picasso/RequestCreator;->j:I

    iget-object v9, p0, Lcom/squareup/picasso/RequestCreator;->m:Ljava/lang/Object;

    iget v10, p0, Lcom/squareup/picasso/RequestCreator;->h:I
    ...
    invoke-direct/range {v0 .. v10}, Lsu$a;-><init>(Lcom/squareup/picasso/Picasso;Lcom/squareup/picasso/Request;Landroid/widget/RemoteViews;I[IIILjava/lang/String;Ljava/lang/Object;I)V
...
.method public into(Lcom/squareup/picasso/Target;)V
    ...
    .line 501
    :cond_0
    iget-boolean v1, p0, Lcom/squareup/picasso/RequestCreator;->a:Z
    ...
    .line 507
    iget-boolean v1, p0, Lcom/squareup/picasso/RequestCreator;->f:Z
    ...
    .line 512
    invoke-static {v3}, Lsy;->a(Lcom/squareup/picasso/Request;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v7}, Lcom/squareup/picasso/Picasso;->a(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-object v6, p0, Lcom/squareup/picasso/RequestCreator;->l:Landroid/graphics/drawable/Drawable;

    iget-object v8, p0, Lcom/squareup/picasso/RequestCreator;->m:Ljava/lang/Object;

    iget v9, p0, Lcom/squareup/picasso/RequestCreator;->h:I

    move-object v2, p1

    invoke-direct/range {v0 .. v9}, Lsx;-><init>(Lcom/squareup/picasso/Picasso;Lcom/squareup/picasso/Target;Lcom/squareup/picasso/Request;IILandroid/graphics/drawable/Drawable;Ljava/lang/String;Ljava/lang/Object;I)V
...
.method public varargs memoryPolicy(Lcom/squareup/picasso/MemoryPolicy;[Lcom/squareup/picasso/MemoryPolicy;)Lcom/squareup/picasso/RequestCreator;
    ...
    iget v1, p1, Lcom/squareup/picasso/MemoryPolicy;->a:I
...
.method public varargs networkPolicy(Lcom/squareup/picasso/NetworkPolicy;[Lcom/squareup/picasso/NetworkPolicy;)Lcom/squareup/picasso/RequestCreator;
    ...
    iget v1, p1, Lcom/squareup/picasso/NetworkPolicy;->a:I
