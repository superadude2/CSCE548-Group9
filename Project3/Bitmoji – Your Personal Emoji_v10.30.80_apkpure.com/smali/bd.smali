...
.method static a(Landroid/transition/TransitionValues;)Landroid/support/transition/TransitionValues;
    ...
    .line 86
    invoke-static {p0, v0}, Lbd;->a(Landroid/transition/TransitionValues;Landroid/support/transition/TransitionValues;)V
...
.method static a(Lbb;Landroid/transition/TransitionValues;)V
    .locals 1
    ...
    .line 68
    invoke-interface {p0, v0}, Lbb;->captureStartValues(Landroid/support/transition/TransitionValues;)V

    .line 69
    invoke-static {v0, p1}, Lbd;->a(Landroid/support/transition/TransitionValues;Landroid/transition/TransitionValues;)V

    .line 70
    return-void
.end method

.method static b(Lbb;Landroid/transition/TransitionValues;)V
    .locals 1
    ...
    .line 77
    invoke-interface {p0, v0}, Lbb;->captureEndValues(Landroid/support/transition/TransitionValues;)V
...
.method static d(Landroid/support/transition/TransitionValues;)Landroid/transition/TransitionValues;
    ...
    .line 96
    invoke-static {p0, v0}, Lbd;->a(Landroid/support/transition/TransitionValues;Landroid/transition/TransitionValues;)V
...
.method public final a()J
    ...
    .prologue
    .line 221
    iget-object v0, p0, Lbd;->a:Landroid/transition/Transition;
...
.method public final a(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 170
    invoke-static {p2, v1}, Lbd;->a(Landroid/support/transition/TransitionValues;Landroid/transition/TransitionValues;)V
    ...
    .line 176
    invoke-static {p3, v0}, Lbd;->a(Landroid/support/transition/TransitionValues;Landroid/transition/TransitionValues;)V

    .line 180
    :cond_0
    iget-object v2, p0, Lbd;->a:Landroid/transition/Transition;
...
.method public final a(Lbc;)Lba;
    ...
    invoke-direct {v0, p0}, Lbd$a;-><init>(Lbd;)V

    iput-object v0, p0, Lbd;->c:Lbd$a;

    .line 114
    iget-object v0, p0, Lbd;->a:Landroid/transition/Transition;

    iget-object v1, p0, Lbd;->c:Lbd$a;
    ...
    .line 1337
    iget-object v0, v0, Lbd$a;->a:Ljava/util/ArrayList;
...
.method public a(Lbb;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p1}, Lbd$b;-><init>(Lbb;)V

    iput-object v0, p0, Lbd;->a:Landroid/transition/Transition;
    ...
    iput-object p2, p0, Lbd;->a:Landroid/transition/Transition;
...
.method public final b(Landroid/support/transition/TransitionValues;)V
    ...
    .line 149
    invoke-static {p1, v0}, Lbd;->a(Landroid/support/transition/TransitionValues;Landroid/transition/TransitionValues;)V

    .line 150
    iget-object v1, p0, Lbd;->a:Landroid/transition/Transition;

    invoke-virtual {v1, v0}, Landroid/transition/Transition;->captureEndValues(Landroid/transition/TransitionValues;)V

    .line 151
    invoke-static {v0, p1}, Lbd;->a(Landroid/transition/TransitionValues;Landroid/support/transition/TransitionValues;)V
...
.method public final c(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
    ...
    invoke-static {v1, v0}, Lbd;->a(Landroid/transition/TransitionValues;Landroid/support/transition/TransitionValues;)V
