...
.method final a(Landroid/support/v7/widget/RecyclerView;Z)V
    ...
    .line 82
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->l:Landroid/support/v7/widget/RecyclerView$Adapter;
    ...
    .line 88
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->e:Lgc;

    invoke-virtual {v1}, Lgc;->d()Z
    ...
    :cond_1
    :goto_0
    iget v1, p0, Lgq$a;->d:I

    iget v2, v0, Landroid/support/v7/widget/RecyclerView$LayoutManager;->w:I
    ...
    .line 101
    iput-boolean p2, v0, Landroid/support/v7/widget/RecyclerView$LayoutManager;->x:Z

    .line 102
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$Recycler;
    ...
    iget v2, p0, Lgq$a;->b:I

    iget-object v3, p1, Landroid/support/v7/widget/RecyclerView;->F:Landroid/support/v7/widget/RecyclerView$State;
...
.method public final addPosition(II)V
    ...
    iput-object v2, p0, Lgq$a;->c:[I

    .line 121
    iget-object v2, p0, Lgq$a;->c:[I
