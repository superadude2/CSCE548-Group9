...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 47
    iput-object p1, p0, Lgf;->c:Landroid/widget/ProgressBar;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 75
    invoke-direct {p0, v0, p2}, Lgf;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lgf;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 99
    iget-object v0, p0, Lgf;->a:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 100
    iput-object v1, p0, Lgf;->a:Landroid/graphics/Bitmap;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    .line 51
    iget-object v0, p0, Lgf;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lgf;->b:[I
    ...
    .line 56
    iget-object v5, p0, Lgf;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lgf;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 61
    iget-object v1, p0, Lgf;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lgf;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
