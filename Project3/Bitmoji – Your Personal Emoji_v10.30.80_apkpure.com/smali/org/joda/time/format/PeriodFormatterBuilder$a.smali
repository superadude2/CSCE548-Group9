.class final Lorg/joda/time/format/PeriodFormatterBuilder$a;
...
.method constructor <init>(Ljava/util/List;)V
    ...
    .line 1776
    invoke-static {p1, v0, v1}, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 1779
    iput-object v3, p0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a:[Lorg/joda/time/format/PeriodPrinter;
    ...
    .line 1786
    iput-object v3, p0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->b:[Lorg/joda/time/format/PeriodParser;
    ...
    iput-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a:[Lorg/joda/time/format/PeriodPrinter;
    ...
    iput-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->b:[Lorg/joda/time/format/PeriodParser;
...
.method private static a(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 1847
    instance-of v3, v0, Lorg/joda/time/format/PeriodFormatterBuilder$a;

    if-eqz v3, :cond_2

    .line 1848
    check-cast v0, Lorg/joda/time/format/PeriodFormatterBuilder$a;

    iget-object v0, v0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a:[Lorg/joda/time/format/PeriodPrinter;

    invoke-static {p1, v0}, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a(Ljava/util/List;[Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->b:[Lorg/joda/time/format/PeriodParser;

    invoke-static {p2, v0}, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a(Ljava/util/List;[Ljava/lang/Object;)V
...
.method public final calculatePrintedLength(Lorg/joda/time/ReadablePeriod;Ljava/util/Locale;)I
    ...
    .line 1804
    iget-object v2, p0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a:[Lorg/joda/time/format/PeriodPrinter;
...
.method public final parseInto(Lorg/joda/time/ReadWritablePeriod;Ljava/lang/String;ILjava/util/Locale;)I
    ...
    .prologue
    .line 1830
    iget-object v1, p0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->b:[Lorg/joda/time/format/PeriodParser;
...
.method public final printTo(Ljava/io/Writer;Lorg/joda/time/ReadablePeriod;Ljava/util/Locale;)V
    ...
    .prologue
    .line 1820
    iget-object v1, p0, Lorg/joda/time/format/PeriodFormatterBuilder$a;->a:[Lorg/joda/time/format/PeriodPrinter;
