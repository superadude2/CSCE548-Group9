...
.field private e:Lorg/joda/time/format/PeriodFormatterBuilder$e;
...
.method private static a(Ljava/util/List;ZZ)Lorg/joda/time/format/PeriodFormatter;
    ...
    instance-of v0, v0, Lorg/joda/time/format/PeriodFormatterBuilder$g;
    ...
    check-cast v0, Lorg/joda/time/format/PeriodFormatterBuilder$g;

    .line 801
    invoke-static {v0}, Lorg/joda/time/format/PeriodFormatterBuilder$g;->a(Lorg/joda/time/format/PeriodFormatterBuilder$g;)Lorg/joda/time/format/PeriodParser;

    move-result-object v2

    if-nez v2, :cond_1

    invoke-static {v0}, Lorg/joda/time/format/PeriodFormatterBuilder$g;->b(Lorg/joda/time/format/PeriodFormatterBuilder$g;)Lorg/joda/time/format/PeriodPrinter;
    ...
    .line 2756
    iput-object v2, v0, Lorg/joda/time/format/PeriodFormatterBuilder$g;->a:Lorg/joda/time/format/PeriodPrinter;

    .line 2757
    iput-object v1, v0, Lorg/joda/time/format/PeriodFormatterBuilder$g;->b:Lorg/joda/time/format/PeriodParser;

    .line 804
    new-instance v1, Lorg/joda/time/format/PeriodFormatter;

    invoke-direct {v1, v0, v0}, Lorg/joda/time/format/PeriodFormatter;-><init>(Lorg/joda/time/format/PeriodPrinter;Lorg/joda/time/format/PeriodParser;)V
...
.method private a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;ZZ)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    .line 734
    :cond_1
    invoke-direct {p0}, Lorg/joda/time/format/PeriodFormatterBuilder;->a()V
    ...
    sget-object v4, Lorg/joda/time/format/PeriodFormatterBuilder$d;->a:Lorg/joda/time/format/PeriodFormatterBuilder$d;

    sget-object v5, Lorg/joda/time/format/PeriodFormatterBuilder$d;->a:Lorg/joda/time/format/PeriodFormatterBuilder$d;
    ...
    invoke-direct/range {v0 .. v7}, Lorg/joda/time/format/PeriodFormatterBuilder$g;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Lorg/joda/time/format/PeriodPrinter;Lorg/joda/time/format/PeriodParser;ZZ)V
    ...
    instance-of v3, v3, Lorg/joda/time/format/PeriodFormatterBuilder$g;
...
.method private a(Lorg/joda/time/format/PeriodFormatterBuilder$e;)Lorg/joda/time/format/PeriodFormatterBuilder;
    .locals 2

    .prologue
    .line 381
    iget-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->e:Lorg/joda/time/format/PeriodFormatterBuilder$e;
    ...
    iget-object v1, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->e:Lorg/joda/time/format/PeriodFormatterBuilder$e;

    invoke-direct {v0, v1, p1}, Lorg/joda/time/format/PeriodFormatterBuilder$b;-><init>(Lorg/joda/time/format/PeriodFormatterBuilder$e;Lorg/joda/time/format/PeriodFormatterBuilder$e;)V

    move-object p1, v0

    .line 384
    :cond_0
    iput-object p1, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->e:Lorg/joda/time/format/PeriodFormatterBuilder$e;
...
.method private a()V
    ...
    iput-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->e:Lorg/joda/time/format/PeriodFormatterBuilder$e;
...
.method private a(II)V
    ...
    iget-object v7, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->e:Lorg/joda/time/format/PeriodFormatterBuilder$e;

    move v1, p2

    move v5, p1

    invoke-direct/range {v0 .. v7}, Lorg/joda/time/format/PeriodFormatterBuilder$c;-><init>(IIIZI[Lorg/joda/time/format/PeriodFormatterBuilder$c;Lorg/joda/time/format/PeriodFormatterBuilder$e;)V
...
.method private static a(Ljava/util/List;)[Ljava/lang/Object;
    ...
    .line 824
    new-instance v1, Lorg/joda/time/format/PeriodFormatterBuilder$a;

    invoke-direct {v1, p0}, Lorg/joda/time/format/PeriodFormatterBuilder$a;-><init>(Ljava/util/List;)V
    ...
    sget-object v1, Lorg/joda/time/format/PeriodFormatterBuilder$d;->a:Lorg/joda/time/format/PeriodFormatterBuilder$d;
...
.method private b(Lorg/joda/time/format/PeriodFormatterBuilder$e;)Lorg/joda/time/format/PeriodFormatterBuilder;
    .locals 4
    ...
    invoke-direct {v1, v0, p1}, Lorg/joda/time/format/PeriodFormatterBuilder$c;-><init>(Lorg/joda/time/format/PeriodFormatterBuilder$c;Lorg/joda/time/format/PeriodFormatterBuilder$e;)V
    ...
    .line 609
    iget-object v0, p0, Lorg/joda/time/format/PeriodFormatterBuilder;->i:[Lorg/joda/time/format/PeriodFormatterBuilder$c;

    .line 2535
    iget v2, v1, Lorg/joda/time/format/PeriodFormatterBuilder$c;->a:I
...
.method public append(Lorg/joda/time/format/PeriodFormatter;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    invoke-direct {p0, v0, v1}, Lorg/joda/time/format/PeriodFormatterBuilder;->a(Lorg/joda/time/format/PeriodPrinter;Lorg/joda/time/format/PeriodParser;)Lorg/joda/time/format/PeriodFormatterBuilder;
...
.method public appendLiteral(Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    invoke-direct {v0, p1}, Lorg/joda/time/format/PeriodFormatterBuilder$d;-><init>(Ljava/lang/String;)V
...
.method public appendPrefix(Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    invoke-direct {v0, p1}, Lorg/joda/time/format/PeriodFormatterBuilder$h;-><init>(Ljava/lang/String;)V

    invoke-direct {p0, v0}, Lorg/joda/time/format/PeriodFormatterBuilder;->a(Lorg/joda/time/format/PeriodFormatterBuilder$e;)Lorg/joda/time/format/PeriodFormatterBuilder;
...
.method public appendPrefix(Ljava/lang/String;Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    .line 366
    :cond_1
    new-instance v0, Lorg/joda/time/format/PeriodFormatterBuilder$f;

    invoke-direct {v0, p1, p2}, Lorg/joda/time/format/PeriodFormatterBuilder$f;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public appendSuffix(Ljava/lang/String;)Lorg/joda/time/format/PeriodFormatterBuilder;
    ...
    invoke-direct {p0, v0}, Lorg/joda/time/format/PeriodFormatterBuilder;->b(Lorg/joda/time/format/PeriodFormatterBuilder$e;)Lorg/joda/time/format/PeriodFormatterBuilder;
...
.method public clear()V
    ...
    .line 183
    new-array v0, v2, [Lorg/joda/time/format/PeriodFormatterBuilder$c;
...
.method public toFormatter()Lorg/joda/time/format/PeriodFormatter;
    ...
    invoke-virtual {v0}, [Lorg/joda/time/format/PeriodFormatterBuilder$c;->clone()Ljava/lang/Object;
