...
.field private J:Landroid/support/v4/widget/SwipeRefreshLayout$OnChildScrollUpCallback;
...
.field h:Landroid/support/v4/widget/MaterialProgressDrawable;
...
.field private final p:Landroid/support/v4/view/NestedScrollingParentHelper;

.field private final q:Landroid/support/v4/view/NestedScrollingChildHelper;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/SwipeRefreshLayout;->k:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->r:[I
    ...
    invoke-direct {v1, v2}, Let;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Let;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->h:Landroid/support/v4/widget/MaterialProgressDrawable;

    .line 1384
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->h:Landroid/support/v4/widget/MaterialProgressDrawable;

    const v2, -0x50506

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/MaterialProgressDrawable;->b(I)V

    .line 1385
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Let;

    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->h:Landroid/support/v4/widget/MaterialProgressDrawable;

    invoke-virtual {v1, v2}, Let;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v1, v2}, Let;->setVisibility(I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->p:Landroid/support/v4/view/NestedScrollingParentHelper;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Landroid/support/v4/view/NestedScrollingChildHelper;
...
.method private a(II)Landroid/view/animation/Animation;
    ...
    .line 518
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Let;

    .line 5090
    iput-object v0, v2, Let;->a:Landroid/view/animation/Animation$AnimationListener;

    .line 519
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Let;

    invoke-virtual {v0}, Let;->clearAnimation()V

    .line 520
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Let;

    invoke-virtual {v0, v1}, Let;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private a(ZZ)V
    ...
    .line 3090
    iput-object v1, v0, Let;->a:Landroid/view/animation/Animation$AnimationListener;
...
.method private b(F)V
    ...
    .line 936
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->h:Landroid/support/v4/widget/MaterialProgressDrawable;

    invoke-virtual {v0, v13}, Landroid/support/v4/widget/MaterialProgressDrawable;->a(Z)V
    ...
    invoke-virtual {v1}, Let;->getVisibility()I
    ...
    invoke-virtual {v1, v4}, Let;->setVisibility(I)V
    ...
    .line 976
    iget-object v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->h:Landroid/support/v4/widget/MaterialProgressDrawable;

    invoke-static {v12, v1}, Ljava/lang/Math;->min(FF)F

    move-result v1

    invoke-virtual {v4, v1}, Landroid/support/v4/widget/MaterialProgressDrawable;->b(F)V
    ...
    .line 6192
    iget-object v2, v2, Landroid/support/v4/widget/MaterialProgressDrawable;->b:Landroid/support/v4/widget/MaterialProgressDrawable$a;

    invoke-virtual {v2, v1}, Landroid/support/v4/widget/MaterialProgressDrawable$a;->c(F)V
...
.method private c()V
    ...
    .prologue
    .line 598
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->l:Landroid/view/View;
    ...
    .line 602
    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->l:Landroid/view/View;
...
.method private c(F)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/MaterialProgressDrawable;->b(F)V
    ...
    .line 8090
    iput-object v0, v1, Let;->a:Landroid/view/animation/Animation$AnimationListener;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/MaterialProgressDrawable;->a(Z)V
...
.method private setColorViewAlpha(I)V
    ...
    invoke-virtual {v0}, Let;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method final a()V
    ...
    invoke-virtual {v0, v1}, Let;->setVisibility(I)V
    ...
    invoke-virtual {v0}, Let;->getTop()I
...
.method final a(F)V
    ...
    invoke-virtual {v1}, Let;->getTop()I
...
.method final a(IZ)V
    ...
    invoke-virtual {v0}, Let;->bringToFront()V
...
.method final a(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    .line 4090
    iput-object p1, v0, Let;->a:Landroid/view/animation/Animation$AnimationListener;
...
.method public canChildScrollUp()Z
    ...
    .line 683
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->J:Landroid/support/v4/widget/SwipeRefreshLayout$OnChildScrollUpCallback;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->l:Landroid/view/View;
...
.method public dispatchNestedFling(FFZ)Z
    ...
    .prologue
    .line 922
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Landroid/support/v4/view/NestedScrollingChildHelper;
...
.method public getNestedScrollAxes()I
    ...
    .prologue
    .line 832
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->p:Landroid/support/v4/view/NestedScrollingParentHelper;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2}, Let;->getTop()I
    ...
    .line 741
    sget-object v1, Landroid/support/v4/widget/SwipeRefreshLayout;->k:Ljava/lang/String;
...
.method protected onLayout(ZIIII)V
    ...
    .line 625
    :cond_1
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->l:Landroid/view/View;
    ...
    invoke-virtual {v1}, Let;->getMeasuredWidth()I
    ...
    invoke-virtual {v2}, Let;->getMeasuredHeight()I

    move-result v2

    .line 639
    iget-object v3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->e:Let;
    ...
    invoke-virtual {v3, v4, v5, v0, v1}, Let;->layout(IIII)V
...
.method public onMeasure(II)V
    ...
    .line 656
    invoke-virtual {v0, v1, v2}, Let;->measure(II)V
...
.method public onNestedPreScroll(Landroid/view/View;II[I)V
    ...
    .line 823
    :cond_1
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->r:[I
...
.method public onNestedScroll(Landroid/view/View;IIII)V
    ...
    .prologue
    .line 853
    iget-object v5, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->s:[I
...
.method public setOnChildScrollUpCallback(Landroid/support/v4/widget/SwipeRefreshLayout$OnChildScrollUpCallback;)V
    ...
    .prologue
    .line 706
    iput-object p1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->J:Landroid/support/v4/widget/SwipeRefreshLayout$OnChildScrollUpCallback;
...
.method public setProgressBackgroundColorSchemeColor(I)V
    ...
    invoke-virtual {v0, p1}, Let;->setBackgroundColor(I)V
...
.method public setProgressViewEndTarget(ZI)V
    ...
    invoke-virtual {v0}, Let;->invalidate()V
...
.method public setSize(I)V
    ...
    invoke-virtual {v0, v1}, Let;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
