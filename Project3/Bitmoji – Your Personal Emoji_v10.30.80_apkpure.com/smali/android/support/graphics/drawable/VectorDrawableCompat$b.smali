.class final Landroid/support/graphics/drawable/VectorDrawableCompat$b;
...
.method public final a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->m:[Landroid/support/graphics/drawable/PathParser$PathDataNode;
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->c:I

    invoke-static {v1, p4, v0, v2, v3}, Lab;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->f:F

    invoke-static {v1, p4, v0, v2, v3}, Lab;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {v1, p4, v0, v2}, Lab;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I

    move-result v2

    .line 2784
    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->j:Landroid/graphics/Paint$Cap;
    ...
    .line 2787
    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->k:Landroid/graphics/Paint$Join;
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->l:F
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->a:I
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->d:F
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->b:F
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->h:F
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->i:F
    ...
    iget v3, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$b;->g:F
