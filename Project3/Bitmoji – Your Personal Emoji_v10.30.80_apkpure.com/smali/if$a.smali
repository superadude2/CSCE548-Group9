...
# direct methods
.method constructor <init>(Lif;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
...
.method private static a(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p0, v1}, Lif$a;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lif$a;->a:Lif;

    const-string v3, "Error querying for table"

    invoke-virtual {v2, v3, p2, v0}, Lif;->zzc(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public final getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0}, Lif;->a(Lif;)Lim;
    ...
    invoke-virtual {v0, v1}, Lif;->zzbT(Ljava/lang/String;)V

    iget-object v0, p0, Lif$a;->a:Lif;

    invoke-static {v0}, Lif;->b(Lif;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lif$a;->a:Lif;

    invoke-virtual {v1}, Lif;->getContext()Landroid/content/Context;
    ...
    invoke-static {v1}, Lif;->a(Lif;)Lim;
    ...
    invoke-virtual {v1, v2, v0}, Lif;->zze(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public final onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1, v2}, Lif$a;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z

    move-result v2

    if-nez v2, :cond_2

    invoke-static {}, Lif;->j()Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v0}, Lif$a;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v2}, Lif$a;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    .line 0
    :cond_8
    invoke-static {p1}, Lif$a;->a(Landroid/database/sqlite/SQLiteDatabase;)V
