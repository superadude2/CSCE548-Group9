...
.field private c:Lnet/hockeyapp/android/UpdateInfoListener;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lnet/hockeyapp/android/UpdateInfoListener;)V
    ...
    .line 40
    iput-object p3, p0, Lnet/hockeyapp/android/utils/VersionHelper;->c:Lnet/hockeyapp/android/UpdateInfoListener;

    .line 42
    invoke-direct {p0, p1, p2}, Lnet/hockeyapp/android/utils/VersionHelper;->a(Landroid/content/Context;Ljava/lang/String;)V
...
.method private a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput v0, p0, Lnet/hockeyapp/android/utils/VersionHelper;->d:I
    ...
    .line 61
    :cond_0
    iput-object v7, p0, Lnet/hockeyapp/android/utils/VersionHelper;->b:Lorg/json/JSONObject;
...
.method public getFileDateString()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lnet/hockeyapp/android/utils/VersionHelper;->a(Lorg/json/JSONObject;Ljava/lang/String;)J
...
.method public getFileSizeBytes()J
    ...
    invoke-static {v0, v1, v2}, Lnet/hockeyapp/android/utils/VersionHelper;->a(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public getReleaseNotes(Z)Ljava/lang/String;
    ...
    .line 1156
    invoke-static {v0}, Lnet/hockeyapp/android/utils/VersionHelper;->a(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    const-string v7, "<a href=\'restore:"
    ...
    const-string v6, "\'  style=\'background: #c8c8c8; color: #000; display: block; float: right; padding: 7px; margin: 0px 10px 10px; text-decoration: none;\'>Restore</a>"
    ...
    .line 1176
    iget-object v5, p0, Lnet/hockeyapp/android/utils/VersionHelper;->b:Lorg/json/JSONObject;

    invoke-static {v5}, Lnet/hockeyapp/android/utils/VersionHelper;->b(Lorg/json/JSONObject;)I

    move-result v5

    .line 1177
    invoke-static {v0}, Lnet/hockeyapp/android/utils/VersionHelper;->b(Lorg/json/JSONObject;)I

    move-result v6

    .line 1178
    invoke-static {v0}, Lnet/hockeyapp/android/utils/VersionHelper;->c(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-static {v0, v5, v6}, Lnet/hockeyapp/android/utils/VersionHelper;->a(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v5, p0, Lnet/hockeyapp/android/utils/VersionHelper;->d:I
    ...
    iput v5, p0, Lnet/hockeyapp/android/utils/VersionHelper;->d:I
