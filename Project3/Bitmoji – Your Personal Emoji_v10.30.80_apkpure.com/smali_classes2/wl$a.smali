...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    .line 58
    iput-object p1, p0, Lwl$a;->a:Ljava/util/concurrent/Executor;
    ...
    iput-object v0, p0, Lwl$a;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object v0, p0, Lwl$a;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Lwl$a;->b:Lrx/subscriptions/CompositeSubscription;
...
.method public final isUnsubscribed()Z
    ...
    .prologue
    .line 170
    iget-object v0, p0, Lwl$a;->b:Lrx/subscriptions/CompositeSubscription;
...
.method public final run()V
    ...
    .line 96
    :cond_0
    iget-object v0, p0, Lwl$a;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    .line 100
    :cond_1
    iget-object v0, p0, Lwl$a;->d:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final schedule(Lrx/functions/Action0;)Lrx/Subscription;
    ...
    .prologue
    .line 66
    invoke-virtual {p0}, Lwl$a;->isUnsubscribed()Z
    ...
    iget-object v1, p0, Lwl$a;->b:Lrx/subscriptions/CompositeSubscription;
    ...
    .line 71
    iget-object v1, p0, Lwl$a;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, v0}, Ljava/util/concurrent/ConcurrentLinkedQueue;->offer(Ljava/lang/Object;)Z

    .line 72
    iget-object v1, p0, Lwl$a;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 78
    :try_start_0
    iget-object v1, p0, Lwl$a;->a:Ljava/util/concurrent/Executor;
    ...
    .line 81
    iget-object v2, p0, Lwl$a;->b:Lrx/subscriptions/CompositeSubscription;
...
.method public final schedule(Lrx/functions/Action0;JLjava/util/concurrent/TimeUnit;)Lrx/Subscription;
    ...
    .line 106
    invoke-virtual {p0, p1}, Lwl$a;->schedule(Lrx/functions/Action0;)Lrx/Subscription;
    ...
    .line 112
    :cond_1
    iget-object v0, p0, Lwl$a;->a:Ljava/util/concurrent/Executor;
    ...
    .line 122
    new-instance v1, Lwl$a$1;

    invoke-direct {v1, p0, v3}, Lwl$a$1;-><init>(Lwl$a;Lrx/subscriptions/MultipleAssignmentSubscription;)V
    ...
    new-instance v5, Lwl$a$2;

    invoke-direct {v5, p0, v3, p1, v1}, Lwl$a$2;-><init>(Lwl$a;Lrx/subscriptions/MultipleAssignmentSubscription;Lrx/functions/Action0;Lrx/Subscription;)V
    ...
    .line 154
    invoke-virtual {v4, v0}, Lrx/internal/schedulers/ScheduledAction;->add(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 115
    :cond_2
    invoke-static {}, Lwm;->a()Ljava/util/concurrent/ScheduledExecutorService;
