...
.method public constructor <init>(Lio/fabric/sdk/android/Kit;Lio/fabric/sdk/android/services/settings/SettingsRequest;Lio/fabric/sdk/android/services/common/CurrentTimeProvider;Lio/fabric/sdk/android/services/settings/SettingsJsonTransform;Lio/fabric/sdk/android/services/settings/CachedSettingsIo;Lio/fabric/sdk/android/services/settings/SettingsSpiCall;)V
    ...
    .line 54
    iput-object p1, p0, Lto;->f:Lio/fabric/sdk/android/Kit;

    .line 55
    iput-object p2, p0, Lto;->a:Lio/fabric/sdk/android/services/settings/SettingsRequest;

    .line 56
    iput-object p3, p0, Lto;->c:Lio/fabric/sdk/android/services/common/CurrentTimeProvider;

    .line 57
    iput-object p4, p0, Lto;->b:Lio/fabric/sdk/android/services/settings/SettingsJsonTransform;

    .line 58
    iput-object p5, p0, Lto;->d:Lio/fabric/sdk/android/services/settings/CachedSettingsIo;

    .line 59
    iput-object p6, p0, Lto;->e:Lio/fabric/sdk/android/services/settings/SettingsSpiCall;

    .line 60
    new-instance v0, Lio/fabric/sdk/android/services/persistence/PreferenceStoreImpl;

    iget-object v1, p0, Lto;->f:Lio/fabric/sdk/android/Kit;

    invoke-direct {v0, v1}, Lio/fabric/sdk/android/services/persistence/PreferenceStoreImpl;-><init>(Lio/fabric/sdk/android/Kit;)V

    iput-object v0, p0, Lto;->g:Lio/fabric/sdk/android/services/persistence/PreferenceStore;
...
.method private a(Lio/fabric/sdk/android/services/settings/SettingsCacheBehavior;)Lio/fabric/sdk/android/services/settings/SettingsData;
    ...
    .line 109
    iget-object v1, p0, Lto;->d:Lio/fabric/sdk/android/services/settings/CachedSettingsIo;
    ...
    .line 112
    iget-object v1, p0, Lto;->b:Lio/fabric/sdk/android/services/settings/SettingsJsonTransform;

    iget-object v3, p0, Lto;->c:Lio/fabric/sdk/android/services/common/CurrentTimeProvider;
    ...
    invoke-static {v2, v3}, Lto;->a(Lorg/json/JSONObject;Ljava/lang/String;)V

    .line 118
    iget-object v2, p0, Lto;->c:Lio/fabric/sdk/android/services/common/CurrentTimeProvider;
...
.method private a()Ljava/lang/String;
    ...
    iget-object v2, p0, Lto;->f:Lio/fabric/sdk/android/Kit;
...
.method public final loadSettingsData()Lio/fabric/sdk/android/services/settings/SettingsData;
    ...
    invoke-virtual {p0, v0}, Lto;->loadSettingsData(Lio/fabric/sdk/android/services/settings/SettingsCacheBehavior;)Lio/fabric/sdk/android/services/settings/SettingsData;
...
.method public final loadSettingsData(Lio/fabric/sdk/android/services/settings/SettingsCacheBehavior;)Lio/fabric/sdk/android/services/settings/SettingsData;
    ...
    .line 2151
    iget-object v0, p0, Lto;->g:Lio/fabric/sdk/android/services/persistence/PreferenceStore;
    ...
    .line 1164
    invoke-direct {p0}, Lto;->a()Ljava/lang/String;
    ...
    .line 76
    invoke-direct {p0, p1}, Lto;->a(Lio/fabric/sdk/android/services/settings/SettingsCacheBehavior;)Lio/fabric/sdk/android/services/settings/SettingsData;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 80
    :try_start_1
    iget-object v0, p0, Lto;->e:Lio/fabric/sdk/android/services/settings/SettingsSpiCall;

    iget-object v2, p0, Lto;->a:Lio/fabric/sdk/android/services/settings/SettingsRequest;
    ...
    .line 83
    iget-object v2, p0, Lto;->b:Lio/fabric/sdk/android/services/settings/SettingsJsonTransform;
    ...
    .line 85
    iget-object v2, p0, Lto;->d:Lio/fabric/sdk/android/services/settings/CachedSettingsIo;
    ...
    invoke-static {v0, v2}, Lto;->a(Lorg/json/JSONObject;Ljava/lang/String;)V
    ...
    .line 2157
    iget-object v2, p0, Lto;->g:Lio/fabric/sdk/android/services/persistence/PreferenceStore;
    ...
    invoke-direct {p0, v1}, Lto;->a(Lio/fabric/sdk/android/services/settings/SettingsCacheBehavior;)Lio/fabric/sdk/android/services/settings/SettingsData;
    :try_end_2
