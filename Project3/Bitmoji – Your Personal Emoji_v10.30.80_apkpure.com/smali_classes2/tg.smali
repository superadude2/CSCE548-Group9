...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ltg;->a:Landroid/content/Context;
...
# virtual methods
.method public final getAdvertisingInfo()Ltd;
    .locals 6
    ...
    invoke-direct {v2, v4}, Ltg$a;-><init>(B)V
    ...
    .line 76
    :try_start_1
    iget-object v3, p0, Ltg;->a:Landroid/content/Context;
    ...
    invoke-virtual {v2}, Ltg$a;->a()Landroid/os/IBinder;

    move-result-object v1

    invoke-direct {v3, v1}, Ltg$b;-><init>(Landroid/os/IBinder;)V

    .line 80
    new-instance v1, Ltd;

    invoke-virtual {v3}, Ltg$b;->a()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3}, Ltg$b;->b()Z

    move-result v3

    invoke-direct {v1, v4, v3}, Ltd;-><init>(Ljava/lang/String;Z)V
    :try_end_2
